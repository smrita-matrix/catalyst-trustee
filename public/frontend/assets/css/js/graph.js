      ...
      function initBusinessPerformanceChart() {
        (function () {
          var YEARS  = ['2016-17','2017-18','2018-19','2019-20','2020-21','2021-22','2022-23','2023-24','2024-25','2025-26'];
          var CATS   = ['Debenture Trustee','Security Trustee','Securitization','Others'];
          var COLORS = ['#c9624c','#4a7fb5','#e8a838','#3d8c6f'];
          var RAW = [
            [513,  109,  245,  21],
            [443,  199,  284,  74],
            [405,  224,  434,  33],
