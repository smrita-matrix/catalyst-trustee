...
// Build on Trust. Recognized for Excellence old
...
mm.add("(min-width: 992px)", () => {
    ...
    ScrollTrigger.create({
        ...
        pin: ".why-choose-cata-home-header-sec",
        pinSpacing: false,
        pinReparent: true
    });
    // Pin right image (if used)
    if (document.querySelector(".sticky-img")) {
        ScrollTrigger.create({
            trigger: ".why-wrap",
            start: "top top+=100",
            end: "bottom bottom",
    ...
    cards.forEach((card) => {
        ScrollTrigger.create({
            trigger: card,
            start: "top 220px", // space for heading
            endTrigger: ".why-wrap",
            end: "bottom bottom",
            pin: true,
            pinSpacing: false
...
$(document).ready(function () {
    ...
    $('.employee-testimonials-carousel').owlCarousel({
        loop: true,
        margin: 30,
        nav: true,
        dots: false,
