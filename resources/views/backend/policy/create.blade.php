          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-body">
                ...
                <form action="{{ route('policy-pages.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
