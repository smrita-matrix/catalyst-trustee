        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Company Overview Banner</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                    <a href="{{ route('company-overview-banner-details.index') }}">Home</a>
                    </li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h4>Company Overview &mdash; Banner</h4>
                        <p class="f-m-light mt-1">Set the breadcrumb banner title, its parent label and the background image.</p>
                    </div>
                    <div class="card-body">
                        <form class="row g-4 needs-validation custom-input banner-form" novalidate action="{{ route('company-overview-banner-details.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <!-- Title -->
                            <div class="col-lg-6">
                                <label class="form-label" for="title">Title <span class="txt-danger">*</span></label>
                                <input class="form-control" id="title" type="text" name="title" value="{{ old('title', 'Company Overview') }}" placeholder="e.g. Company Overview" required>
                            ...
                            <div class="col-lg-6">
                                ...
                                <input class="form-control" id="breadcrumb_parent" type="text" name="breadcrumb_parent" value="{{ old('breadcrumb_parent', 'About') }}" placeholder="e.g. About">
                            ...
                            <div class="col-12 d-flex justify-content-end gap-2 border-top pt-4 mt-2">
                                <a href="{{ route('company-overview-banner-details.index') }}" class="btn btn-outline-secondary px-4">Cancel</a>
