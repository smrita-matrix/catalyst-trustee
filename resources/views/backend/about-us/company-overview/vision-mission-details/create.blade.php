            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">Set the section heading and add the vision / mission cards.</p>
                    </div>
                    <div class="card-body">
                        <form class="row g-4 needs-validation custom-input banner-form" novalidate action="{{ route('company-overview-vision-mission-details.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <!-- Heading -->
                            <div class="col-12">
                                <label class="form-label" for="heading">Section Heading</label>
                                <input class="form-control" id="heading" type="text" name="heading" value="{{ old('heading', 'Vision & Mission') }}" placeholder="e.g. Vision & Mission">
                            </div>
                            ...
                            <div class="col-12">
                                        ...
                                        <tbody id="items-tbody">
                                            ...
                                            @foreach ($oldTitles as $i => $oldTitle)
                                                <tr class="item-row">
                                                    ...
                                                    <td><input class="form-control" type="text" name="item_tag[]" value="{{ old('item_tag')[$i] ?? '' }}" placeholder="e.g. VISION"></td>
                                                    <td>
                                                    ...
                                                    <td><input class="form-control" type="text" name="item_title[]" value="{{ $oldTitle }}" placeholder="e.g. Our Vision"></td>
                                ...
                                <small class="text-secondary"><i class="fa fa-info-circle"></i> Each card: tag (e.g. VISION), icon (.png/.jpg/.webp/.svg, max 2MB), title and description. Empty rows are ignored.</small>
                            </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function rowTemplate() {
            ...
            row.innerHTML =
                ...
                '<td><input class="form-control mb-2 item-image-input" type="file" name="item_icon[]" accept=".png, .jpg, .jpeg, .webp, .svg"><div class="img-preview item-image-preview"></div></td>' +
