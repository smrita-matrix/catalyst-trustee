                        ...
                        <form class="row g-4 needs-validation custom-input banner-form" novalidate action="{{ route('group-companies-difc-details.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="form-control" id="theme" name="theme">
                                    <option value="dark" {{ old('theme') === 'terracotta' ? '' : 'selected' }}>Dark grey &mdash; as Catalyst (DIFC) uses</option>
                                    <option value="terracotta" {{ old('theme') === 'terracotta' ? 'selected' : '' }}>Terracotta &mdash; as Monarch uses</option>
                                </select>
                            </div>
                            <div class="col-lg-6">
