          ...
          <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <form class="row g-4 needs-validation custom-input banner-form" novalidate action="{{ route('our-journey-banner-details.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-lg-6">
                                ...
                                <input class="form-control" id="title" type="text" name="title" value="{{ old('title', $banner->title) }}" placeholder="e.g. Our Journey" required>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="img-preview bg-image-preview">
                                    @if ($banner->background_image)
                                        <img id="existing_bg" src="{{ asset('about-us/our-journey/banner/' . $banner->background_image) }}" alt="bg">
                                    @endif
                                </div>
                            </div>
