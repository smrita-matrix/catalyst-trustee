        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit SEBI Services Section</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit SEBI Services</li>
                </ol>
                </div>
              </div>
            </div>
          ...
          <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <form class="row g-4 needs-validation custom-input banner-form" novalidate action="{{ route('sebi-service-details.update', $sebi_service->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-12">
                                ...
                                <input class="form-control" id="heading" type="text" name="heading" value="{{ old('heading', $sebi_service->heading) }}" placeholder="e.g. SEBI Regulated Trustee Services" required>
                                ...
                                <div id="items-wrapper">
                                    @php
                                        $existingItems = old('item_title')
                                            ...
                                            : ($sebi_service->items ?: [['title' => '', 'title_link' => '', 'description' => '', 'read_more_link' => '', 'service_img' => null, 'icon' => null]]);
                                    @endphp
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="img-preview mt-2 service-img-preview">
                                                        @if (!empty($item['service_img']))
                                                            <img src="{{ asset('home/sebi-services/' . $item['service_img']) }}" alt="service image">
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="img-preview mt-2 icon-preview">
                                                        @if (!empty($item['icon']))
                                                            <img src="{{ asset('home/sebi-services/' . $item['icon']) }}" alt="icon">
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
