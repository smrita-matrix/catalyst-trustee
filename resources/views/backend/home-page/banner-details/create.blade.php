                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-4 needs-validation custom-input banner-form" novalidate action="{{ route('banner-details.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input class="form-control" id="button_link" type="text" name="button_link" list="site-pages" value="{{ old('button_link') }}" placeholder="Start typing, or pick a page from the list" required>
