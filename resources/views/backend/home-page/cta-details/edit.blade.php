            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">Update the heading, description, button and the background image.</p>
                    </div>
                    <div class="card-body">
                        <form class="row g-4 needs-validation custom-input banner-form" novalidate action="{{ route('cta-details.update', $cta->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-12">
                                ...
                                <input class="form-control" id="heading" type="text" name="heading" value="{{ old('heading', $cta->heading) }}" placeholder="e.g. Connect With Catalyst Trusteeship Limited" required>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="editor" name="description" placeholder="Enter the CTA description">{{ old('description', $cta->description) }}</textarea>
                            </div>

                            <!-- Button Text -->
                            <div class="col-lg-6">
                                <label class="form-label" for="button_text">Button Text</label>
                                <input class="form-control" id="button_text" type="text" name="button_text" value="{{ old('button_text', $cta->button_text) }}" placeholder="e.g. Connect With Our Specialists">
                            </div>

                            <!-- Button Link -->
                            <div class="col-lg-6">
                                <label class="form-label" for="button_link">Button Link</label>
                                <input class="form-control" id="button_link" type="text" name="button_link" value="{{ old('button_link', $cta->button_link) }}" placeholder="e.g. /contact-us or #">
                            </div>
                            ...
                            <!-- Preview / Current -->
                            <div class="col-lg-6">
                                <label class="form-label">{{ $cta->background_image ? 'Current Image' : 'Preview' }}</label>
                                <div class="img-preview bg-image-preview">
                                    @if ($cta->background_image)
                                        <img id="existing_bg" src="{{ asset('home/cta/' . $cta->background_image) }}" alt="bg">
                                    @endif
                                </div>
                            </div>
