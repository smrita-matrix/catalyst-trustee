              ...
              <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="con-us-con-info-cus-box" data-aos="fade-up" data-aos-duration="800">
                  <div class="con-us-con-info-cus-content">
                    ...
                    <h4>Address</h4>
                    @php $addressUrl = $content->address_link
                        ?: 'https://www.google.com/maps/search/?api=1&query=' . urlencode($content->address); @endphp
                    <p><a href="{{ $addressUrl }}" target="_blank" rel="noopener noreferrer">{{ $content->address }}</a></p>
                  </div>
                </div>
              </div>
              @endif
            ...
            <div class="row">
              ...
              <div class="col-sm-6" data-aos="fade-up" data-aos-duration="900">
                <div class="hq-card">
                  ...
                  <p class="hq-address">
                    @if($o->map_url)
                      <a href="{{ $o->map_url }}" target="_blank" rel="noopener noreferrer">{!! nl2br(e($o->address)) !!}</a>
                    @else
                      {!! nl2br(e($o->address)) !!}
                    @endif
                  </p>
                  ...
                  @endif
                  @if($o->map_url)
                  <a href="{{ $o->map_url }}" target="_blank" class="hq-link">View location
